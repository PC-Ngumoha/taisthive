...
import { berries_on_table } from '@/assets/images';
    ...
    >
      ...
      <div className="flex h-full flex-1 flex-col justify-center px-4 py-6">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <h2
            className="mt-10 text-center text-2xl font-lobster font-bold leading-9 tracking-wide text-gray-700
          capitalize"
          >
            Create <span className="font-pacifico text-primary">your</span>{' '}
            account
          </h2>
        </div>
          ...
          <form className="space-y-6 font-sans" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  ring-inset ring-gray-300 focus:ring-1 focus:ring-inset focus:ring-primary sm:text-sm
                  sm:leading-6 outline-none tracking-tight"
                />
              </div>
            </div>
            ...
            <div>
              <button
                ...
                leading-6 text-secondary shadow-sm hover:bg-primary-light focus-visible:outline
                hover:scale-105 duration-200 ease-linear focus-visible:outline-2 focus-visible:outline-offset-2
                focus-visible:outline-primary disabled:bg-secondary-light font-lobster tracking-widest
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3
                py-1.5 text-sm font-semibold leading-6 text-gray-900 shadow-sm ring-1 ring-inset
                ring-gray-300 hover:bg-gray-50 focus-visible:ring-2"
              >
                <svg
