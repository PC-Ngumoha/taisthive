...
router.post('/api/v1/recipe/:user_id', async (req, res) => {
  const data = req.body;
...
router.put('/api/v1/recipe/:id', async (req, res) => {
  const data = req.body;
...
router.delete('/api/v1/recipe/:id', async (req, res) => {
  const id = req.params.id;
  try {
...
router.get('/api/v1/recipe/user/:user_id', async (req, res) => {
...
router.get('/api/v1/recipe/:id', async (req, res) => {
  const id = req.params.id;
  try {
